    ...
    <form v-tabindex>
      <div class="row">
            ...
            <div class="d-flex flex-wrap flex-md-nowrap align-items-center">
              ...
              <div class="v-title">
                ...
                <b-form-invalid-feedback
                  >Please input subject or short description for
                  task.</b-form-invalid-feedback
                >
              </div>
            </div>
          </b-form-group>
          ...
          <b-card no-body>
            <div class="tabs">
              ...
              <div class="tab-content mt-3">
                <div
                  class="tab-pane v-md-container card-body is-loading"
                  :class="!preview ? 'active' : ''"
                >
                  <textarea
                    ref="txt"
                    ...
                    class="v-md-wrapper form-control"
                    :style="styles"
                    @change="onTextChange"
                  />
                </div>
                <div
                  class="tab-pane v-md-preview card-body"
                  :class="preview ? 'active' : ''"
                >
                  <div
                    v-if="txtHtmlRender"
              ...
              <div
                class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pl-3 pr-3 pb-3"
              >
                <div class="f-xs">
                  <a
                    class="markdown-guide"
                    target="_blank"
        ...
        <div class="col-lg-12 col-xl-10 mt-sm-4 mt-lg-0">
          ...
          <todo-dropdown
            label="Project"
            :toggle-icon.sync="edit.project"
            :label-value="todo.project"
            :on-click="onToggle('project')"
          >
            <vue-multiselect
              id="project"
              ref="project"
              ...
              tag-placeholder="enter to project created."
...
export default {
  ...
  computed: {
    ...
    gravatar() {
      const avatar = this.$auth.user.email
  ...
  methods: {
    async onSaveTask(status) {
      ...
      if (!this.todo.title)
        return this.$toast.open({ message: 'Title is empty.', type: 'warning' })
      ...
      try {
        this.saved = true
        const { data } = await this.$axios.post('/api/todo', this.todo)
        this.saved = false
    ...
    onProjectChange(value) {
      ...
      if (value.length < 3)
        return this.$toast.open({
          message: 'Project name short.',
          type: 'warning',
        })
      this.todo.project = value.trim().replace(/[\\/]/gi, '')
